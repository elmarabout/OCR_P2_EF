...
def drop_doppledanger(df1, df2, col_name):
    dd = df1[~df1[col_name].isin(df2[col_name].unique())]
    dd_step2 = dd.drop_duplicates(subset=[col_name], keep="last")
    dd_step3 = (dd_step2[col_name].unique().tolist())
    print("post dropdoppledanger",dd_step3)
    return None
